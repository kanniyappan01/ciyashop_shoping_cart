        ...
        <div className='container'>
            {wishListProducts.length > 0 ? (
                <div className='row'>
                    <div className='col-lg-12'>
                        <div className='table_responsive'>
                            <table className='wishlist_table table'>
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th></th>
                                        <th className='product_name'>Product Name</th>
                                        <th className='product_price'>Unit Price</th>
                                        <th className='Quantity_status'>Stock Status</th>
                                        <th className='product_actions'></th>
                                    </tr>
                                </thead>
                                <tbody>
                ...
                <div className='d-flex justify-content-center'>
                    <div className='wishlist_not_found'>
                        ...
                        <h4 className='mb-3'>WishList empty.</h4>
                        <Link to={'/products'} className='shop_btn' onClick={handleReturnShop}>Continue Shopping</Link>
                    </div>
                </div>
            )}
        </div>
